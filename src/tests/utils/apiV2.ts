...
export function mockApi(): void {
	...
	jest.spyOn(api, 'listGeysers').mockReturnValue(
		Promise.resolve([
			{
				asset: 'sBTCCRV',
				apy: 8.369928860456682,
				balance: 2580.4779797767615,
				hasBouncer: false,
				name: 'Curve.fi renBTC/wBTC/sBTC',
				ppfs: 1.0082389531413567,
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 7.021534846913739,
						performance: {
							oneDay: 7.021534846913739,
							threeDay: 7.021534846913739,
							sevenDay: 7.021534846913739,
							thirtyDay: 7.021534846913739,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 3.6885260041428705,
						performance: {
							oneDay: 3.6885260041428705,
							threeDay: 3.6885260041428705,
							sevenDay: 3.6885260041428705,
							thirtyDay: 3.6885260041428705,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 7.433310231343793,
						performance: {
							oneDay: 7.433310231343793,
							threeDay: 7.433310231343793,
							sevenDay: 7.433310231343793,
							thirtyDay: 7.433310231343793,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 9.169998373866079,
						performance: {
							oneDay: 9.169998373866079,
							threeDay: 9.169998373866079,
							sevenDay: 9.169998373866079,
							thirtyDay: 9.169998373866079,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 29.92897428074679,
						performance: {
							oneDay: 29.92897428074679,
							threeDay: 29.92897428074679,
							sevenDay: 29.92897428074679,
							thirtyDay: 29.92897428074679,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Digg Rewards',
						apy: 68.98034235123771,
						performance: {
							oneDay: 68.98034235123771,
							threeDay: 68.98034235123771,
							sevenDay: 68.98034235123771,
							thirtyDay: 68.98034235123771,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 4.51411529408918,
						performance: {
							oneDay: 4.51411529408918,
							threeDay: 4.51411529408918,
							sevenDay: 4.51411529408918,
							thirtyDay: 4.51411529408918,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 22.80598455206412,
						performance: {
							oneDay: 22.80598455206412,
							threeDay: 22.80598455206412,
							sevenDay: 22.80598455206412,
							thirtyDay: 22.80598455206412,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Digg Rewards',
						apy: 56.62489250549427,
						performance: {
							oneDay: 56.62489250549427,
							threeDay: 56.62489250549427,
							sevenDay: 56.62489250549427,
							thirtyDay: 56.62489250549427,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 5.8375902091592335,
						performance: {
							oneDay: 5.8375902091592335,
							threeDay: 5.8375902091592335,
							sevenDay: 5.8375902091592335,
							thirtyDay: 5.8375902091592335,
						},
					},
				],
				tokens: [
			...
			},
			{
				...
				sources: [
					...
					{
						name: 'Badger Rewards',
						apy: 59.63540074982681,
						performance: {
							oneDay: 59.63540074982681,
							threeDay: 59.63540074982681,
							sevenDay: 59.63540074982681,
							thirtyDay: 59.63540074982681,
						},
					},
					{
						name: 'Digg Rewards',
						apy: 29.649064482058275,
						performance: {
							oneDay: 29.649064482058275,
							threeDay: 29.649064482058275,
							sevenDay: 29.649064482058275,
							thirtyDay: 29.649064482058275,
						},
					},
				],
				tokens: [
