...
describe('Boost Optimizer', () => {
  ...
  it('can change native and non native balances', () => {
    ...
    const nativeInput = screen.getByRole('textbox', {
      name: 'native holdings amount',
    });
    const nonNativeInput = screen.getByRole('textbox', {
      name: 'non native holdings amount',
    });
  ...
  it('can increase balances through the increase button', () => {
    ...
    const increaseNativeButton = screen.getByRole('button', {
      name: 'increase native holdings',
    });
    const increaseNonNativeButton = screen.getByRole('button', {
  ...
  it('can decrease balances through the increase button', () => {
    ...
    const decreaseNativeButton = screen.getByRole('button', {
      name: 'decrease native holdings',
    });
    const decreaseNonNativeButton = screen.getByRole('button', {
  ...
  it('can jump to rank', () => {
    ...
    const rankToJump = screen.getByRole('button', {
      name: 'Hyper Badger Rank',
    });
