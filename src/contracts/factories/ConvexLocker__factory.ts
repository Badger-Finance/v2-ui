...
import type { ConvexLocker, ConvexLockerInterface } from '../ConvexLocker';
...
export class ConvexLocker__factory {
	static readonly abi = _abi;
	static createInterface(): ConvexLockerInterface {
		return new utils.Interface(_abi) as ConvexLockerInterface;
	}
	static connect(address: string, signerOrProvider: Signer | Provider): ConvexLocker {
		return new Contract(address, _abi, signerOrProvider) as ConvexLocker;
	}
}
