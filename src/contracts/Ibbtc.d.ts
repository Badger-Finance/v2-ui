...
interface IbbtcInterface extends ethers.utils.Interface {
	functions: {
		...
		'switchCore(address)': FunctionFragment;
	...
	encodeFunctionData(functionFragment: 'switchCore', values: [string]): string;
	...
	decodeFunctionResult(functionFragment: 'switchCore', data: BytesLike): Result;
...
export class Ibbtc extends BaseContract {
	...
	callStatic: {
		...
		switchCore(_core: string, overrides?: CallOverrides): Promise<void>;
	...
	estimateGas: {
		...
		switchCore(_core: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
