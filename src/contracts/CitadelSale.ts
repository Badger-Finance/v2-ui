...
export interface CitadelSaleInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'boughtAmounts',
    values: [string],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'daoCommitments',
    values: [BigNumberish],
  ): string;
  ...
  encodeFunctionData(
    functionFragment: 'getTokenInLimitLeft',
    values?: undefined,
  ): string;
  ...
  encodeFunctionData(
    functionFragment: 'setTokenInLimit',
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
    functionFragment: 'setTokenOutPrice',
    values: [BigNumberish],
  ): string;
  ...
  encodeFunctionData(
    functionFragment: 'tokenInLimit',
    values?: undefined,
  ): string;
  encodeFunctionData(functionFragment: 'tokenOut', values?: undefined): string;
  encodeFunctionData(
    functionFragment: 'tokenOutPrice',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'totalTokenIn',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'totalTokenOutBought',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'totalTokenOutClaimed',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface CitadelSale extends BaseContract {
  ...
  functions: {
    ...
    saleEnded(
      overrides?: CallOverrides,
    ): Promise<[boolean] & { hasEnded_: boolean }>;
