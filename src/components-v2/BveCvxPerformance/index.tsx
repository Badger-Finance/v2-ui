      ...
      <Grid item container spacing={4}>
        <Grid item xs={12} sm={6}>
          ...
          <Typography className={classes.firstParagraph} variant="body2" color="textSecondary">
            This vault locks 100% of deposited Convex tokens for rolling periods of 16 weeks. Badger will use vlCVX to
            vote for bribes during each voting round, sell them, and emit the proceeds back to holders in the form of
            bveCVX (autocompounded), and claimable BADGER and bcvxCRV.
          </Typography>
          <Typography variant="body2" color="textSecondary">
            Unlike other Badger Vaults, bveCVX limits the times when users may withdraw their funds. Limited pre-unlock
            liquidity is available through this{' '}
