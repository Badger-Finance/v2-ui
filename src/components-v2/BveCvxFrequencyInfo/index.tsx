    ...
    <BveCvxInfoDialog open={open} onClose={onClose}>
      ...
      <BveCvxInfoDialog.Content>
        <Typography variant="body1" color="textSecondary">
          bveCVX and BADGER rewards are distributed at the completion of each bi-weekly voting/bribing round, after
          bribes for that round have been sold. Convex locking rewards are distributed each ~2hr cycle as
          autocompounding{' '}
