...
const RemunerationVaultAdvisory = ({ accept }: VaultAdvisoryBaseProps): JSX.Element => {
  return (
    <GenericVaultAdvisory accept={accept}>
      ...
      <p>
        Once withdrawn, you will not be able to re-deposit, and as a result, agree to forfeit any future accrued Badger
        rewards emitted throughout the designated restitution period as outlined in{' '}
      ...
      <p>
        The amount of redeemable remBADGER will depend on when it’s withdrawn and will increase over time as additional
