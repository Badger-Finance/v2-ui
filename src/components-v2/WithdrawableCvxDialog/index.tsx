    ...
    <Dialog {...props}>
      ...
      <DialogContent>
        <Typography variant="body1">
          Each week, this vault locks batches of CVX tokens for a 16 week period. As vlCVX unlocks on a rolling basis,
          CVX becomes available to withdraw from the vault. Alternatively, bveCVX may be traded for CVX via the{' '}
