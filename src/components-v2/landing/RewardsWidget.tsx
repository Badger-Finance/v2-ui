    ...
    <>
      ...
      >
        <DialogTitle className={classes.title}>
          ...
          <IconButton aria-label="go back to rewards" className={classes.closeButton} onClick={() => setOpen(false)}>
            <CloseIcon />
          </IconButton>
        </DialogTitle>
              ...
              <Grid item xs={12} sm={6}>
                <Grid container direction="column" className={classes.moreRewardsInformation}>
                  ...
                  <Grid item className={classes.rewardsGuideLinkContainer}>
                    <Link className={classes.cursorPointer} color="primary" onClick={() => setGuideMode(true)}>
                      Rewards User Guide
                    </Link>
                  </Grid>
                </Grid>
