...
const routes = {
        ...
        subtitle={
          <Box display="flex" alignItems="center">
            <Typography variant="body2" color="textSecondary">
              ...
              <Link color="primary" target="_blank" href="https://badger.com/new-to-defi" rel="noreferrer">
                New to Defi?
              </Link>
            </Typography>
          </Box>
  ...
  guarded: new Route<RootStore, QueryParams>({
    path: '/guarded',
    component: (
      <Landing title="Guarded Vaults" subtitle="New vaults to dip your toes in. Ape safe." state={VaultState.Guarded} />
    ),
  }),
