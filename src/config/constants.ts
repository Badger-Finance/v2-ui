...
export const APP_NEWS_MESSAGE = 'As Badger engineers investigate reports of unauthorized withdrawals, all smart contracts have been paused to prevent further withdrawals. More info to come.';
