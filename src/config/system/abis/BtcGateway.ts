...
export const BTC_GATEWAY: AbiItem[] = [
	{
		anonymous: false,
		inputs: [
			{
	...
	},
	{
		constant: true,
		inputs: [
			{ internalType: 'bytes32', name: '_pHash', type: 'bytes32' },
			{ internalType: 'uint256', name: '_amount', type: 'uint256' },
	...
	},
	{
		...
		inputs: [
			...
			{ internalType: 'uint16', name: '_mintFee', type: 'uint16' },
			{ internalType: 'uint16', name: '_burnFee', type: 'uint16' },
			{
				internalType: 'uint256',
	...
	},
	{
		...
		inputs: [
			{
				internalType: 'contract GatewayLogicV1',
	...
	{
		constant: false,
		inputs: [{ internalType: 'uint16', name: '_nextBurnFee', type: 'uint16' }],
		name: 'updateBurnFee',
		outputs: [],
		payable: false,
		stateMutability: 'nonpayable',
	...
	{
		constant: false,
		inputs: [{ internalType: 'uint16', name: '_nextMintFee', type: 'uint16' }],
		name: 'updateMintFee',
		outputs: [],
		payable: false,
		stateMutability: 'nonpayable',
