		...
		case Network.Arbitrum:
			return {
				[arbitrumDeploy.sett_system.vaults['native.sushiWethSushi']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(1000),
						[StrategyFee.strategistPerformance]: BigNumber.from(1000),
						[StrategyFee.withdraw]: BigNumber.from(10),
					},
					userGuide:
				...
				[arbitrumDeploy.sett_system.vaults['native.crvWbtcRen']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(1000),
						[StrategyFee.strategistPerformance]: BigNumber.from(1000),
						[StrategyFee.withdraw]: BigNumber.from(50),
					},
				...
				[arbitrumDeploy.sett_system.vaults['native.tricryptoLight']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(350),
						[StrategyFee.strategistPerformance]: BigNumber.from(350),
						[StrategyFee.withdraw]: BigNumber.from(10),
					},
					userGuide:
		...
		default:
			return {
				[ethDeploy.sett_system.vaults['native.badger']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(0),
						[StrategyFee.strategistPerformance]: BigNumber.from(0),
						[StrategyFee.withdraw]: BigNumber.from(0),
					},
				...
				[ethDeploy.sett_system.vaults['harvest.renCrv']]: {
					...
					fees: {
						[StrategyFee.harvestPerformance]: BigNumber.from(1000),
						[StrategyFee.harvestStrategistPerformance]: BigNumber.from(1000),
						[StrategyFee.withdraw]: BigNumber.from(50),
					},
				...
				[ethDeploy.sett_system.vaults['yearn.wBtc']]: {
					...
					fees: {
						[StrategyFee.yearnPerformance]: BigNumber.from(2000),
						[StrategyFee.yearnManagement]: BigNumber.from(200),
						[StrategyFee.withdraw]: BigNumber.from(50),
					},
				...
				[ethDeploy.sett_system.vaults['native.sushiibBTCwBTC']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(1000),
						[StrategyFee.strategistPerformance]: BigNumber.from(1000),
						[StrategyFee.withdraw]: BigNumber.from(20),
					},
				...
				[ethDeploy.sett_system.vaults['experimental.digg']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(250),
						[StrategyFee.strategistPerformance]: BigNumber.from(0),
						[StrategyFee.withdraw]: BigNumber.from(50),
					},
					depositLink:
				...
				[ethDeploy.sett_system.vaults['native.tricryptoCrv2']]: {
					...
					fees: {
						[StrategyFee.performance]: BigNumber.from(2000),
						[StrategyFee.withdraw]: BigNumber.from(50),
					},
