    ...
    case Network.Arbitrum:
      return {
        [arbitrumDeploy.sett_system.vaults['native.sushiWethSushi']]: {
          ...
          userGuide: 'https://docs.badger.com/badger-finance/sett-user-guides/arbitrum-sushi-weth-helper-vault',
        ...
        [arbitrumDeploy.sett_system.vaults['native.tricryptoLight']]: {
          ...
          userGuide: 'https://app.gitbook.com/@badger-finance/s/badger-finance/sett-user-guides/arbitrum-tricrypto-crv',
          depositLink: 'https://arbitrum.curve.fi/tricrypto/deposit',
        },
