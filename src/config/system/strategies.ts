    ...
    case Network.Fantom:
      return {
        ...
        [fantomDeploy.sett_system.vaults['native.bveoxd-oxd']]: {
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-fantom/fantom-bveoxd-oxd',
        },
    ...
    case Network.Arbitrum:
      return {
        [arbitrumDeploy.sett_system.vaults['native.sushiWethSushi']]: {
          ...
          depositLink:
            'https://app.sushi.com/add/ETH/0xd4d42F0b6DEF4CE0383636770eF773390d85c61A',
        },
        [arbitrumDeploy.sett_system.vaults['native.sushiWethWbtc']]: {
          ...
          depositLink:
            'https://app.sushi.com/add/ETH/0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f',
        },
    ...
    default:
      return {
        [ethDeploy.sett_system.vaults['native.badger']]: {
          strategyLink:
            'https://badger.wiki/strategies#fe02e2fa6ea446ca9b975d1eecf3120c',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/badger',
          depositLink:
        ...
        [ethDeploy.sett_system.vaults['native.rembadger']]: {
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/rembadger',
        },
        [ethDeploy.sett_system.vaults['native.renCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#2304f0f6a0684aee82853f9635211ec9',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.sbtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#ce634a6ad4b0486288180d775a1552ab',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.tbtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#cba0515b901e423d892f9c0cf66b272f',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.uniBadgerWbtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#9da96d000b3e49cc92f04a49dd08a9bd',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.sushiWbtcEth']]: {
          ...
          strategyLink:
            'https://badger.wiki/strategies#2f5ee4a857754023af1fdba144a0c1be',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.sushiBadgerWbtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#46bfa12ac9d24b9bb7d28d1f9bc3256a',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.digg']]: {
          strategyLink:
            'https://badger.wiki/strategies#b63c02c4f27f43229624da8abb377be2',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/digg',
          depositLink:
        ...
        [ethDeploy.sett_system.vaults['native.sushiDiggWbtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#e1a46fc7a95d4f73b586435f45586748',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['yearn.wBtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#8dbbd221e429409db3b487da966a14b8',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.sushiibBTCwBTC']]: {
          strategyLink:
            'https://badger.wiki/strategies#418b98a05da849a3a8dd97f74f8c0c80',
          userGuide:
        ...
        [ethDeploy.sett_system.vaults['native.mim-3crv']]: {
          ...
          strategyLink:
            'https://badger.wiki/strategies#691cfc90b4a6453da20ac3a37aca1ab1',
        },
        [ethDeploy.sett_system.vaults['native.frax-3crv']]: {
          ...
          strategyLink:
            'https://badger.wiki/strategies#570fcd8b773242a9bc22c1b4c53dcb60',
        },
        [ethDeploy.sett_system.vaults['native.hbtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#56cd7b65cd384740aa9f339bf3ee2597',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/convex-hbtc',
          depositLink: 'https://curve.fi/hbtc/deposit',
        },
        [ethDeploy.sett_system.vaults['native.pbtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#39a0decd933b4869b98c9276118b9d39',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/convex-pbtc',
          depositLink: 'https://curve.fi/pbtc/deposit',
        },
        [ethDeploy.sett_system.vaults['native.obtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#82d72e94cb3b49f0836d8197ad13bc36',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/convex-obtc',
          depositLink: 'https://curve.fi/obtc/deposit',
        },
        [ethDeploy.sett_system.vaults['native.bbtcCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#fe4a64edc830472da5a700d0fc30716c',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/convex-bbtc',
          depositLink: 'https://curve.fi/bbtc/deposit',
        },
        [ethDeploy.sett_system.vaults['native.tricryptoCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#f03b01a576d241aa9d9cee153876c976',
        },
        [ethDeploy.sett_system.vaults['native.tricryptoCrv2']]: {
          strategyLink:
            'https://badger.wiki/strategies#d5806054c232432e8e8a1d75ae329bf8',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/tricrypto2',
          depositLink: 'https://curve.fi/tricrypto2/deposit',
        },
        [ethDeploy.sett_system.vaults['native.cvxCrv']]: {
          strategyLink:
            'https://badger.wiki/strategies#51d48102bc4847a6a5a1a059c4b827b3',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/cvxcrv-helper',
        },
        [ethDeploy.sett_system.vaults['native.cvx']]: {
          strategyLink:
            'https://badger.wiki/strategies#1346adfaad7946eebd29a17fb4f6e8b7',
          userGuide:
            'https://docs.badger.com/badger-finance/setts/sett-user-guides-ethereum/cvx-helper',
        },
        [ethDeploy.sett_system.vaults['native.icvx']]: {
          ...
          userGuide:
            'https://docs.badger.com/badger-finance/sett-user-guides/blcvx-locked-convex',
        },
        [ethDeploy.sett_system.vaults['native.imBtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#2234cf88bca941ce9450548c9eb96cec',
          depositLink: 'https://mstable.app/#/mbtc/save',
          userGuide:
            'https://docs.badger.com/badger-finance/sett-user-guides/mstable-imbtc',
        },
        [ethDeploy.sett_system.vaults['native.fPmBtcHBtc']]: {
          strategyLink:
            'https://badger.wiki/strategies#9a88b07c857e42beab929d3f0e26ca1b',
          depositLink:
            'https://mstable.app/#/mbtc/pools/0x48c59199da51b7e30ea200a74ea07974e62c4ba7',
          userGuide:
            'https://docs.badger.com/badger-finance/sett-user-guides/mstable-mbtc-hbtc',
        },
