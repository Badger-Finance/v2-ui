	...
	switch (network) {
		...
		case NETWORK_LIST.ETH:
			return {
				...
				tokenMap: {
					[deploy.sett_system.vaults['native.sushiDiggWbtc']]: '0x9a13867048e01c663ce8Ce2fE0cDAE69Ff9F35E3',
					[deploy.sett_system.vaults['native.sbtcCrv']]: '0x075b1bb99792c9E1041bA13afEf80C91a1e70fB3',
					[deploy.sett_system.vaults['native.digg']]: '0x798D1bE841a82a273720CE31c822C61a67a601C3',
					[deploy.sett_system.vaults['native.badger']]: '0x3472A5A71965499acd81997a54BBA8D852C6E53d',
					[deploy.sett_system.vaults['harvest.renCrv']]: '0x49849C98ae39Fff122806C06791Fa73784FB3675',
					[deploy.sett_system.vaults['native.renCrv']]: '0x49849C98ae39Fff122806C06791Fa73784FB3675',
					[deploy.sett_system.vaults['native.sushiBadgerWbtc']]: '0x110492b31c59716AC47337E616804E3E3AdC0b4a',
					[deploy.sett_system.vaults['native.uniBadgerWbtc']]: '0xcD7989894bc033581532D2cd88Da5db0A4b12859',
					[deploy.sett_system.vaults['native.sushiWbtcEth']]: '0xCEfF51756c56CeFFCA006cD410B03FFC46dd3a58',
					[deploy.sett_system.vaults['native.uniDiggWbtc']]: '0xE86204c4eDDd2f70eE00EAd6805f917671F56c52',
					[deploy.sett_system.vaults['native.tbtcCrv']]: '0x64eda51d3Ad40D56b9dFc5554E06F94e1Dd786Fd',
					[deploy.sett_system.vaults['yearn.wBtc']]: NETWORK_CONSTANTS[NETWORK_LIST.ETH].TOKENS.WBTC_ADDRESS,
				},
			};
		default:
			return {
