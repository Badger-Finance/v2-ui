...
import { getNetwork } from 'mobx/utils/web3';

export var tokens: TokenNetworkConfig | null = null;
...
// TODO: Properly type these  exports
export const curveTokens: any = tokens.curveTokens;
export const priceEndpoints: any = tokens.priceEndpoints;
export const tokenBatches: any = tokens.tokenBatches;
export const decimals: any = tokens.decimals;
export const symbols: any = tokens.symbols;
export const names: any = tokens.names;
export const tokenMap: any = _.zipObject(tokens.vaultMap, tokens.tokenMap);
