        ...
        {isEarn && (
          <Grid item xs={12}>
            <Typography variant="body1" color="textPrimary" align="left">
              Mint & Earn deposits your BTC into the selected vault which starts earning more BTC for you passively
            </Typography>
          </Grid>
        )}
        ...
        <Grid item xs={12}>
          <TextField
            ...
            InputProps={{
              ...
              endAdornment: [
                <div key="btc">
                  <img className={classes.tokenIcon} src={`/assets/icons/btc.svg`} alt="bitcoin icon" />
