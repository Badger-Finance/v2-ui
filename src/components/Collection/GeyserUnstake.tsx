	...
	const renderAmounts = (
		<ButtonGroup size="small">
			<Button
				...
				variant={watch().amount === uiStats.depositedFull[25] ? 'contained' : 'outlined'}
				color="primary"
			>
				25%
			</Button>
			<Button
				...
				variant={watch().amount === uiStats.depositedFull[50] ? 'contained' : 'outlined'}
				color="primary"
			>
				50%
			</Button>
			<Button
				...
				variant={watch().amount === uiStats.depositedFull[75] ? 'contained' : 'outlined'}
				color="primary"
			>
				75%
			</Button>
			<Button
				...
				variant={watch().amount === uiStats.depositedFull[100] ? 'contained' : 'outlined'}
				color="primary"
			>
				100%
			</Button>
